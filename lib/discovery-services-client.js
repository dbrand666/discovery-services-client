...
function generateAPI(initOpts, cb) {
    ...
    var url = initOpts.discoveryRestUrl || initOpts.discoveryServiceUrl;
    var file = initOpts.discoveryRestFile || initOpts.discoveryServiceFile;
    var isService =
        initOpts.discoveryServiceUrl || initOpts.discoveryServiceFile;

    if (!url && !file) {
        isService = true;
        url = defaultDiscoveryServiceUrl;
    }
